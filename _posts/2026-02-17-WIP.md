...
<table border="1" cellspacing="0" cellpadding="4">
  ...
  <tbody>
    <tr><th>home</th><td>6,505</td><td>29,801</td><td>23,377</td><td>34,961</td><td>25,770</td><td>0</td><td>9,111</td><td>0</td></tr>
    <tr><th>search</th><td>4,256</td><td>4,242</td><td>13,493</td><td>13,714</td><td>13,672</td><td>0</td><td>4,197</td><td>0</td></tr>
    <tr><th>category</th><td>4,078</td><td>4,132</td><td>4,152</td><td>11,499</td><td>20,974</td><td>5,278</td><td>2,122</td><td>0</td></tr>
    <tr><th>bounce</th><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td></tr>
    <tr><th>product</th><td>10,325</td><td>7,494</td><td>8,964</td><td>17,066</td><td>7,499</td><td>17,162</td><td>5,969</td><td>0</td></tr>
    <tr><th>cart</th><td>978</td><td>0</td><td>0</td><td>4,060</td><td>4,411</td><td>1,913</td><td>2,006</td><td>10,985</td></tr>
    <tr><th>support</th><td>8,272</td><td>4,981</td><td>2,249</td><td>7,715</td><td>2,153</td><td>0</td><td>2,142</td><td>0</td></tr>
    <tr><th>checkout</th><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td></tr>
  </tbody>
</table>
</div>

*From each state i (row) to state j (column), we observe this many transition counts from the dataset.*

In the table of observed counts above, no transitions originate from either absorbing state. Further, there exist transient states that are not reachable from others, like support → cart. This makes sense given the structure of the website. Next, we'll estimate transition probabilities using these counts for each state-to-state transition. Recall the formula for estimating the transition probability P&#770;<sub>ij</sub>:

$$
\normalsize \hat{P}_{ij} = \frac{c_{ij}}{\sum_{k} c_{ik}}
$$

You might notice a small issue. Because no transitions exist originating *from* several states above, the denominator in this formula summing total counts *from* those states is zero. To avoid dividing by zero and corrupting our transition probability matrix, we can introduce a concept known as smoothing. This adds a small constant to every transition count, ensuring no probability is zero and all rows sum to one. This stabilizes estimates when some transitions are missing in the data.

$$
\hat{P}_{ij} = \frac{c_{ij} + \alpha}{\sum_k (c_{ik} + \alpha)}, \quad |S| \text{ = total number of states}
$$

We will define an alpha value of 0.1 for smoothing. Now, we can build out our transition probability matrix.

...
Let's investigate one last scenario. Suppose we run an advertisement on the category pages to promote products. How many checkout conversions should we expect to pass through a category page? Well, this is a standard conditional probability question.

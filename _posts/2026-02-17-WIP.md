...
print(prob)
```
The observed probability is 17.3% — that's pretty close to our model's estimate! Next, let's answer this: For a session that begins on the homepage, what is the expected number of clicks to reach checkout?
